/**
 * MobileUIHandler Module (Creative HUD Rehaul - v3.2)
 *
...
const MobileUIHandler = {
    ...
    init() {
        ...
        console.log("Mobile UI Handler (HUD Rehaul v3.2) Initialized.");
    },
    ...
    populateSplitView(sourceWindow) {
        ...
        if (drawerContentContainer) {
            if (pilotHeader) drawerContentContainer.appendChild(pilotHeader.cloneNode(true));
            if (flightDataMain) {
